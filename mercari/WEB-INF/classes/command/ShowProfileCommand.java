...
//	    System.out.println("user_id="+sessionUserId);
        ...
        try {
        	...
        	buyHistory = dealDao.getAllDeals(sessionUserId," and (deal_state = 3 or deal_state = 2)");
        	sellHistory = dealDao.getSellAllDeals(sessionUserId," and (deal_state = 3 or deal_state = 2)");
